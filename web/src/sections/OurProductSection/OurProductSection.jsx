...
export const OurProductSection = ({
  ...
  return (
    ...
    >
      <div className="max-w-[1512px] mx-auto lg:px-[70px] px-4 lg:py-20 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 mx-auto">
          {cards.map(({ image, heading, _rawSubText }) => {
            return (
              <div className="relative mx-auto group h-[350px]">
                <Image imageData={image} otherClasses="absolute h-[300px]" />
